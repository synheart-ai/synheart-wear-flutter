...
enum DeviceAdapter {
  /// Platform-native health store: Apple HealthKit on iOS, Health Connect
  /// on Android. The SDK selects the backend at runtime based on host OS.
  platformHealth,
...
class SynheartWearConfig {
  ...
  SynheartWearConfig.development()
    : this(
        enabledAdapters: const {DeviceAdapter.platformHealth},
