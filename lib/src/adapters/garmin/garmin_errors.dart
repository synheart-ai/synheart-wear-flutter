...
class GarminPairingError extends GarminSDKError {
  ...
  GarminPairingError(
    ...
    Exception? originalException,
         ...
         message,
         code: 'GARMIN_PAIRING_ERROR',
         originalException: originalException,
       );

  @override
  String toString() {
    final deviceInfo = deviceIdentifier != null
