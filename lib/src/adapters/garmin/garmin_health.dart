...
class GarminHealth {
  ...
  Stream<List<ScannedDevice>> get scannedDevicesStream =>
      _adapter.deviceManager.scannedDevicesStream
  ...
  static DeviceConnectionState _mapConnectionState(GarminConnectionState state) {
    switch (state) {
  ...
  static GarminConnectionState _reverseConnectionState(DeviceConnectionState state) {
    switch (state) {
