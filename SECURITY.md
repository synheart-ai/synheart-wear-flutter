...
1. **GitHub Security Advisory (preferred).**
   [Open a private advisory](https://github.com/synheart-ai/synheart-wear-flutter/security/advisories/new).
...
This policy covers the `synheart_wear` SDK published from this repository. Issues
