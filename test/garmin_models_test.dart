...
void main() {
  ...
  group('GarminDeviceType', () {
    ...
    test('supportsRealTimeStreaming returns correct values', () {
      ...
      expect(GarminDeviceType.cyclingComputer.supportsRealTimeStreaming, isFalse);
      expect(GarminDeviceType.golfWatch.supportsRealTimeStreaming, isFalse);
    });

    test('displayName returns human readable strings', () {
      expect(GarminDeviceType.fitnessTracker.displayName, equals('Fitness Tracker'));
      expect(GarminDeviceType.runningWatch.displayName, equals('Running Watch'));
    });
  });
  ...
  group('GarminScannedDevice', () {
    ...
    test('equality works based on identifier', () {
      ...
      final device2 = GarminScannedDevice(identifier: 'id1', name: 'Device 1 Updated');
  ...
  group('GarminDevice', () {
    ...
    test('copyWith creates new instance with updated fields', () {
      ...
      expect(original.connectionState, equals(GarminConnectionState.disconnected));
    });
  ...
  group('GarminRealTimeData', () {
    ...
    test('roundtrip serialization works', () {
      ...
      expect(restored.bbiIntervals!.length, equals(original.bbiIntervals!.length));
  ...
  group('GarminWellnessEpoch', () {
    ...
    test('duration calculates correctly', () {
      ...
      final epoch = GarminWellnessEpoch(
        startTime: startTime,
        endTime: endTime,
      );
  ...
  group('GarminSleepStage', () {
    ...
    test('parseSleepStageType handles variants', () {
      ...
      expect(GarminSleepStage.fromMap(map1).stage, equals(GarminSleepStageType.deep));
      ...
      expect(GarminSleepStage.fromMap(map2).stage, equals(GarminSleepStageType.awake));
    });
  });
