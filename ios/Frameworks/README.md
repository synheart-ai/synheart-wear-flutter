...
1. Download `Companion.xcframework-4.7.x.zip` from your Garmin
   Health SDK distribution channel (provisioned by Garmin Health
...
[`../../doc/GARMIN_SETUP.md`](../../doc/GARMIN_SETUP.md).
